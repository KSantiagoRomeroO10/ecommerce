...
-- La base de datos est� organizada de manera que cada vendedor puede realizar muchas ventas,
-- pero cada venta pertenece solo a un vendedor. A su vez, una venta puede incluir varios
-- productos, y un mismo producto puede estar presente en muchas ventas. Esta relaci�n entre
-- productos y ventas se gestiona a trav�s de una tabla intermedia llamada venta_producto,
-- que permite registrar cu�ntos productos se vendieron y a qu� precio. As�, se reflejan de
...
('Camiseta Azul', 35000.00, 'Camiseta de algod�n talla M', 100),
('Pantal�n Jeans', 85000.00, 'Jeans azul oscuro, corte slim', 60),
...
('Cintur�n de Cuero', 38000.00, 'Cintur�n marr�n ajustable', 65);

-- Insertar vendedores
INSERT INTO vendedores (nombre_vendedor, correo_vendedor, comision_vendedor) VALUES
('Laura G�mez', 'laura.gomez@ecommerce.com', 10),
('Carlos Ruiz', 'carlos.ruiz@ecommerce.com', 12),
('Andrea Torres', 'andrea.torres@ecommerce.com', 15),
('David L�pez', 'david.lopez@ecommerce.com', 11),
('Mariana R�os', 'mariana.rios@ecommerce.com', 13);
